...
export default makeScene2D(function* (view) {
	...
	yield* all(
		scale(0, 1, easeInOutCubic),
		graphScale(0, 1, easeInOutCubic),
		graphPosition(new Vector2(xWidth() / 2, -yHeight() / 2), 1, easeInOutCubic),
		latexPosition(new Vector2(xWidth() / 2, -yHeight() / 2), 1),
