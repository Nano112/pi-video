...
export default makeScene2D(function* (view) {
	...
	yield* all(
		scale(0, 2, easeOutQuint),
		graphScale(0, 2, easeOutQuint),
		graphPosition(new Vector2(0, 0), 2, easeOutQuint),
		latexPosition(new Vector2(0, 0), 2, easeOutQuint),
		position(new Vector2(0, 0), 2, easeOutQuint)
	);
