...
export default makeScene2D(function* (view) {
	...
	const colBWidth = createSignal(1);
	const colAWidth = createSignal(0);
		...
		<>
			...
			>
				<Rect
					...
					ref={colB}
					width={() => {
						console.log("colBWidth", colBWidth());
						return colBWidth() * layoutRef().width();
					}}
				>
					<CodeBlock
						ref={codeRef}
	...
	yield layoutRef().add(
		...
		>
			<Layout
				...
				justifyContent={"center"}
				gap={20}
				width={() => colAWidth() * layoutRef().width()}
			></Layout>
		</Rect>
	);
	...
	yield* all(
		...
		colAWidth(percentWidth, 2, easeInOutCubic),
		colBWidth(1 - percentWidth, 2, easeInOutCubic),
		layoutGap(80, 2),
		layoutRadius(80, 2)
	);
