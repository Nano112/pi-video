...
export default makeScene2D(function* (view) {
	...
	yield* all(
		zeroLabelPosition(() => new Vector2(-50, 0), 1, easeInOutElastic),
		xOneLabelPosition(() => new Vector2(endX() + 20, 0), 1, easeInOutElastic),
		angleY(-Math.PI / 2, 2, easeInOutElastic),
		position(new Vector2(-xWidth() / 2, yHeight() / 2), 2, easeInOutElastic),
		scale(0.9, 2, easeInOutElastic)
	);
